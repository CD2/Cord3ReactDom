...
var CordTable = (0, _mobxReact.observer)(_class = (_class2 = function (_React$Component) {
  _inherits(CordTable, _React$Component);
  ...
  function CordTable() {
    ...
    _classCallCheck(this, CordTable);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CordTable.__proto__ || Object.getPrototypeOf(CordTable)).call.apply(_ref, [this].concat(args))), _this), _initDefineProp(_this, "recordsPromise", _descriptor, _this), _initDefineProp(_this, "records", _descriptor2, _this), _initDefineProp(_this, "loaded", _descriptor3, _this), _this.handleCollectionChange = function () {
      _this.recordsPromise = _this.props.collection.toArray();
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(CordTable, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _mobx.reaction)(function () {
        return _this2.recordsPromise;
      }, function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(prom) {
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  console.log(_this2.props.collection._sort, "balahsf");
                  _context.next = 3;
                  return prom;

                case 3:
                  _this2.records = _context.sent;

                  console.log(_this2.records.map(function (r) {
                    return r.id;
                  }));
                  _this2.loaded = true;
    ...
    value: function render() {
      ...
      if (this.records.length === 0) return _react2.default.createElement(
        "div",
        { className: this.props.className + " no-results" },
        "No entries"
      );
  ...
  return CordTable;
}(_react2.default.Component), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "recordsPromise", [_mobx.observable], {
  enumerable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "records", [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return [];
  }
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "loaded", [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
